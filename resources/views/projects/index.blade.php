                ...
                container.innerHTML += `
                    <div class="bg-surface-container-high text-on-surface px-4 py-2 rounded-full border border-outline-variant flex items-center gap-2">
                        ...
                        <span
                            ...
                            class="material-symbols-outlined text-[16px] cursor-pointer hover:text-primary">
                            close
                        </span>
                    </div>
                `;
    ...
    <main class="max-w-3xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-400">
                Define your next technical milestone.
            </p>
        </div>
        ...
        <form
                ...
                <label class="relative cursor-pointer border border-slate-700 rounded-xl bg-slate-900 aspect-video flex items-center justify-center overflow-hidden hover:border-violet-400 transition">
                    ...
                    <div id="placeholder" class="flex flex-col items-center gap-3 z-10">
                        ...
                        <div class="w-14 h-14 rounded-full bg-violet-500/20 flex items-center justify-center">
                            <span class="material-symbols-outlined text-violet-300">
                                add_a_photo
                            </span>
                        </div>
            ...
            <!-- TITLE -->
            <div class="space-y-2">
                <label for="project-title" class="block text-sm text-slate-300">
                    Project Title
                </label>
                ...
                <input
                    ...
                    class="w-full rounded-xl bg-slate-900 border border-slate-700 px-4 py-3 focus:border-violet-400 focus:ring-0">
            </div>

            <!-- DESCRIPTION -->
            <div class="space-y-2">
                <label for="project-desc" class="block text-sm text-slate-300">
                    Description
                </label>
                ...
                <textarea
                    ...
                    class="w-full rounded-xl bg-slate-900 border border-slate-700 px-4 py-3 resize-none focus:border-violet-400 focus:ring-0"></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    <label for="project-date" class="block text-sm text-slate-300">
                        Target Date
                    </label>
                ...
                <div class="space-y-2">
                    <label for="category" class="block text-sm text-slate-300">
                        Category
                    </label>
            ...
            <section class="space-y-3">
                ...
                <div class="flex gap-2">
                    ...
                    <input
                        ...
                        class="flex-1 rounded-xl bg-slate-900 border border-slate-700 px-4 py-3 focus:border-violet-400 focus:ring-0">

                    <button
                        type="button"
                        onclick="addSkill()"
                        class="px-4 rounded-xl bg-violet-500 hover:bg-violet-600 transition">
            ...
            <div class="pt-4 space-y-3">
                ...
                <button
                    type="submit"
                    class="w-full py-4 rounded-xl bg-violet-500 hover:bg-violet-600 font-semibold transition">
                ...
                <a href="/dashboard"
                    class="block w-full text-center py-4 rounded-xl border border-slate-700 hover:bg-slate-800 transition">
