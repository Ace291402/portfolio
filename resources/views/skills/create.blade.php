...
<body class="bg-slate-950 text-white min-h-screen">
    <header class="sticky top-0 z-50 bg-slate-900 border-b border-slate-700">
        <div class="max-w-4xl mx-auto flex items-center justify-between px-6 py-4">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-2xl font-bold text-violet-300">Add Skill</h1>
            </div>
    ...
    <main class="max-w-3xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            <h2 class="text-3xl font-bold mb-2">New Skill</h2>
            <p class="text-slate-400">Add a skill to showcase your expertise.</p>
        </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <button type="button" id="dropdownBtn"
                        ...
                        <span id="selectedValue" class="text-white">{{ old('category', 'Language') }}</span>
                        <span class="material-symbols-outlined text-slate-500">expand_more</span>
                    </button>
                    <input type="hidden" name="category" id="categoryInput" value="{{ old('category', 'Language') }}">
            ...
            <div class="space-y-3">
                <div class="flex items-end justify-between">
                    ...
                    <div class="flex items-baseline gap-2">
                        <span id="levelValue" class="text-2xl font-bold text-violet-300">75</span>
                        <span class="text-sm text-slate-400">%</span>
                    </div>
                </div>
                <input type="range" name="level" id="skillRange" min="0" max="100" value="{{ old('level', 75) }}" 
